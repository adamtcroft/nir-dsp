...
2026-02-24: Keep `docs/Tasks.md` items small and concrete (avoid open-ended "continue improving" phrasing), otherwise the nightly run has no clear "done" signal and tasks won't naturally get deleted.
